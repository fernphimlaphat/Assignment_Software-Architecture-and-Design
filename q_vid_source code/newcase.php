...
<?php
    ...
    if (isset($_GET['s_status'])) {
        ...
        $userdata = new Fetchonestatus();
        $result = $userdata->fetchonestatus($status);
    }else{
        //คิวรี่ข้อมูลสินค้าทุกรายการ
       //  $stmt = $conn->prepare("SELECT* FROM tbl_patients");
       $userdata = new Allmembers();
      ...
      <div class="container-fluid">
        ...
        <button type="button" class="btn btn-primary">เลือกระดับอาการ</button>
          ...
          <div class="dropdown-menu">
            <a href="newcase.php" class="list-group-item list-group-item-action">ผู้ป่วยทุกระดับทั้งหมด</a> 
            <?php foreach($resultPrdType as $rowPrdType) {  ?>
            <a href="newcase.php?s_status=<?= $rowPrdType['s_status'];?>&name=<?= $rowPrdType['status_name'];?>"  
                                    ...
                                    <tbody>
                                         <?php
                                              if(isset($_GET['name'])){
                                                ...
                                                echo '<h5 align=center style="color:navy"> ประเภทผู้ป่วย: ผู้ป่วยทั้งหมด</h5><hr>';
                                                }
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                  <a class="btn btn-primary btn-xs" href="patient_info.php?p_id=<?php echo $row['p_id']; ?>">
